...
- HF pre-inventories and transaction boundary: `docs/huggingface-audit.md`
...
The two README-only post-update revisions are intentionally absent from this Phase A source
candidate. They may be added only after the separately authorized HF transaction and verification.
